...
| `scripts/rank/m33_saturation.captured.log` | `c8d077c21b6f20f4456a79c4bd051d578089af1e06bd7e26567d407ff3d3416f` | `740fa8d524cf078022ef92509dc596d7` | rigorous: saturation of (-35,240) on E_33 minimal model, index 1 (backs Theorem ranks(a) generator claim; analytic rank as auxiliary check) |
| `scripts/rank/m33_saturation.sage` | `452d6f37bb5f6169be30ddfe4b5e6bcd5c0b8c91b3a64210ce2cfe4e9562bae7` | `7d33ce1d557104b34f403ab792e957c3` | rigorous input script |
...
| `scripts/rank/s21_e0_saturation.captured.log` | `5ced3ff9b9fb3cab5af43213fbe65224fcf2dab8eb06dc66144d15092cd9aa00` | `e1af58b72f9cd751da7823779c3cb3dc` | rigorous: rank bounds (1,1) and saturation of (-8,36) on E_0, index 1 (backs Theorem ranks(b); analytic rank 1 as auxiliary check) |
| `scripts/rank/s21_e0_saturation.sage` | `d74ff1069e64c8517fa7a9d4328c0f0dd3836808d1da77663797085379f6a082` | `ef56e63dced929b03fbdbcdad1af8672` | rigorous input script |
...
| `scripts/sage/bk_errata_576i3.captured.log` | `b650a6609797afe81f2e138ec969630fc8ab041b2bde795ea12b327228400f5b` | `cc5b1375a1c2360c09574709fe429728` | rigorous: BK 1995 table rows n=2,3 internal inconsistency -- printed points equal -2Q,-3Q while printed a-values correspond to +2Q,+3Q (backs the errata remark; true printed values, orientation-independent) |
| `scripts/sage/bk_errata_576i3.sage` | `b9634b14a060b7e43fbf7eb98ebec91513e6b829c44b1834d3fbb9a061cf195b` | `dd79ed36450fabd33526e62e75ee897f` | rigorous input script |
| `scripts/sage/guy_multiples.captured.log` | `b1dde8ed172d6b8a6eb4dbff328061de4910e6ad31d671e4ad987341ad1431fe` | `bf1fd814f6ce6c9277dbd5a7a051510c` | rigorous: a(2P)-a(5P) on E, both gates at each multiple, Guy 1989 four printed pairs identified (pair 4 via a<->1/a), Klamkin translate check (backs Theorem curve(c)) |
| `scripts/sage/guy_multiples.sage` | `68798d8f21df0eb533fdbf89bfcf03dc28c13839ed5b678c4618a41a574599b8` | `e49445f60870d34a928642a6d6eb654e` | rigorous input script |
...
| `scripts/terrain/terrain_crosscheck.captured.log` | `eccfaa7e0eda57abc038458da815d629c2c148aeb05f14b6c1e87dfe2a19e662` | `de81ef91e12fc023987099b3548440a8` | rigorous unconditional (42 CHECK lines, all True; zero False anywhere) |
