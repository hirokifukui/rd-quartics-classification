...
a transparent negative control (P7).  A green node below is kernel-verified; the two
non-green nodes (\lean{BMThm7Transcript.T9_bridge} and, in
Chapter~\ref{chap:boundary}, \lean{BMThm7Transcript.Conjecture1_normal}) are the open
propositions.
...
\begin{definition}[The T9 bridge --- OPEN]\label{T9_bridge}\lean{BMThm7Transcript.T9_bridge}
...
$f'$ split over $\Q$, $\mathrm{sym}\neq 0$, and $x_{0}$ is a highest local minimum.  The
...
is the bridge from all of the above to ``$r$ and $s$ are rational''.  It does not exist
(P2), because it was assumed (P1).
