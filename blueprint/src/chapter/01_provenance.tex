...
every route to the conclusion known to us passes through Conjecture~1
...
is a statement about Theorem~7 over $\Q$.  Both refutations are of the
\emph{reconstructed} formal propositions; that the reconstruction captures the hypotheses
materially used in the printed argument is the transcript-fidelity claim --- a documented
human judgement (Chapter~\ref{chap:transcript}, the adjudication record), not itself a
kernel theorem.  The pre-registration record itself (\texttt{Gap/STEPS.md},
predictions fixed before any Lean build) is a methodological audit trail ---
predictions and confirmations were both produced within this project --- and is
presented as procedural transparency, not as independent verification; the public
provenance chain (bibliography, hashes, dates) is \texttt{Gap/PROVENANCE.md}.
