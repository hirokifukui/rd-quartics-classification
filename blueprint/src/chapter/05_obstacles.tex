...
\begin{remark}[Wall W4: no examined mechanism yields finiteness]\label{wall-covers}
Chapter~\ref{chap:boundary} shows that away from the symmetric locus (which carries no admissible rational points,
Chapter~\ref{chap:boundary}), the conclusion of Theorem~7 demands the lifting of rational points through
...
The companion programme --- whose artifacts live outside this repository; the main-line theorems of the present artifact close on the standard three axioms, with the single disclosed axiom \texttt{rank\_E576i2} retained off the main line (Remark~\ref{rem:rank}) --- has a current summit theorem for
