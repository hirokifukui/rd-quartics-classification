...
the verdict that none of the eight is a square --- so $\sqrt{Q_{4}}\notin\Q(S)$ and
$\sqrt{-2Q_{4}}\notin\Q(S)$, and all three covers are irreducible nontrivial double
covers of $S$.  Point~1 is the $K$-witness $(-51/13,-17/7)$; point~2 is $(1,3)$.  The eight negativity certificates are the kernel anchors; as of 2026-08-02 the
