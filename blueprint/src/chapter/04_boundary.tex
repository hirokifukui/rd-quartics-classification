...
retains both).  Degree four and integrality follow [M].
...
\begin{proposition}[Normalization bridge]\label{prop:normalization_bridge}
...
\end{proposition}
\begin{proof}[Proof {[M]}; both directions, every normalisation condition tracked]
...
Proposition~\ref{prop:normalization_bridge}.  Formally, only sufficiency
